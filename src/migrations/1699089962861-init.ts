...
export class Init1699089962861 implements MigrationInterface {
  name = 'Init1699089962861';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "country-tax" ("country" character varying NOT NULL, "tax_percentage" double precision NOT NULL, "tax_rate_to_apply" double precision NOT NULL, CONSTRAINT "PK_48dfc64d6f81769c9f0481f7515" PRIMARY KEY ("country"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "stock_indexes" ("isin" character varying NOT NULL, "ticker" character varying NOT NULL, "name" character varying NOT NULL, "currency" character varying NOT NULL, "category" "public"."stock_indexes_category_enum", "country" character varying NOT NULL, CONSTRAINT "PK_5ab853edddd57b1affe00b56832" PRIMARY KEY ("isin"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."stock_dividends_type_enum" AS ENUM('ORDINARY', 'PROPERTY_INCOME', 'BONUS')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("country" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" text NOT NULL, "password" text NOT NULL, CONSTRAINT "PK_5cb2b3e0419a73a360d327d497f" PRIMARY KEY ("country"))`,
    );
    await queryRunner.query(
